...
/// Symmetrically encrypts the given plaintext using ChaCha20-Poly1305 and the
/// given additional authenticated data (AAD).
///
...
/// Symmetrically decrypts the given ciphertext using ChaCha20-Poly1305 and the
/// given additional authenticated data (AAD).
///
